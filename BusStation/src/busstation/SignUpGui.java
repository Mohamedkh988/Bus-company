...
public class SignUpGui extends javax.swing.JFrame {
    ...
    private void creataccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_creataccountActionPerformed
       int i=JOptionPane.showConfirmDialog(null,"Are you sure You want to save ??");
        if(i==0){
        try{ cu.readFile();
        if(cu.IsValidEmail(email.getText())){
...
cu.savePeopleFile();}
    ...
    private void coname(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_coname
        // TODO add your handling code here:
    ...
    private void visanumKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_visanumKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
    ...
    }//GEN-LAST:event_visanumKeyTyped
